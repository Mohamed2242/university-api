        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContainsPracticalOrProject = table.Column<bool>(type: "bit", nullable: true),
                    HaveAssistants = table.Column<bool>(type: "bit", nullable: true),
                    MidTerm = table.Column<double>(type: "float", nullable: true),
                    FinalExam = table.Column<double>(type: "float", nullable: true),
                    Quizzes = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasRegisteredCourses = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssistantCourses", x => new { x.AssistantsId, x.CoursesId });
                    table.ForeignKey(
                        name: "FK_AssistantCourses_Assistants_AssistantsId",
                        column: x => x.AssistantsId,
                        principalTable: "Assistants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssistantCourses_Courses_CoursesId",
                        column: x => x.CoursesId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorCourses", x => new { x.CoursesId, x.DoctorsId });
                    table.ForeignKey(
                        name: "FK_DoctorCourses_Courses_CoursesId",
                        column: x => x.CoursesId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DoctorCourses_Doctors_DoctorsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentDegrees", x => new { x.StudentId, x.CourseId });
                    table.ForeignKey(
                        name: "FK_StudentDegrees_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssistantCourses_CoursesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorCourses_DoctorsId",
                table: "DoctorCourses",
                column: "DoctorsId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentDegrees_CourseId",
